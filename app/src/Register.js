            ...
            <div className="register-page">
                <div>
                    ...
                    <input placeholder="请输入邮箱"
                        ...
                        onChange={(e) => this.handleTextChange('email', e)}></input>
                </div>
                <div>
                    <span className="form-desc">昵称</span>
                    <input placeholder="请输入昵称"
                        value={this.state.userName}
                        onChange={(e) => this.handleTextChange('userName', e)}></input>
                </div>
                <div>
                    <span className="form-desc">密码</span>
                    <input placeholder="请输入密码"
                        value={this.state.password}
                        onChange={(e) => this.handleTextChange('password', e)}></input>
                </div>
                <button className="confirm" onClick={this.confirm}>注册</button>
            </div>
        )
    }
}
