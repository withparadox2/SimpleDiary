		...
		return (
			<Grid container justify="center">
				...
				>
					...
					<div>
						<Typography variant="body2" className="form-desc" align="left">
							Email*
						</Typography>
						<div>
							<input
					...
					<div className="btn-group">
						<Button className="btnStyle" variant="contained" size="large" onClick={this.confirm}>
							{' '}
							Log in
						</Button>
						<div style={{ marginTop: '1.5em' }}>
							<p className="rlink" onClick={this.register}>
